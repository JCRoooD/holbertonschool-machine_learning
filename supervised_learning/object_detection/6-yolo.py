...
class Yolo:
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        ...
        Args:
            ...
            boxes: a numpy.ndarray of shape (grid_height, grid_width,
            anchor_boxes, 4) containing the processed boundary boxes for each
            output, respectively
            box_classes: a numpy.ndarray of shape (grid_height, grid_width,
            anchor_boxes, classes) containing the processed box class
            probabilities for each output, respectively
            box_scores: a numpy.ndarray of shape (grid_height, grid_width,
        ...
        for i, box in enumerate(boxes):
            ...
            color = (255, 0, 0)
            thickness = 2
            image = cv2.rectangle(image, top_left, bottom_right, color,
                                  thickness)
