#!/usr/bin/env python3
"""
Creating a model that can predict the price of Bitcoin based on historical data.

The model will be trained on the Bitstamp dataset, which contains 1-minute data
from 2012 to 2020.

The model will be a Bidirectional LSTM model with 64 units and a single output
layer.
